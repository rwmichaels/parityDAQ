...
/***** globals *****/
// HAPPEX III setpoints
int bmw_coil_0_amplitude=200;
int bmw_coil_1_amplitude=200;
int bmw_coil_2_amplitude=100;
int bmw_coil_3_amplitude=100;
int bmw_coil_4_amplitude=250;
int bmw_coil_5_amplitude=250;
int bmw_coil_6_amplitude=100;
int bmw_coil_7_amplitude=50;
...
int bmw_coil_7_cycles_per_pulse=1;   /* was 0 */


int bmw_RFlock_in_HallC = 1;
int bmw_RFlock_in_HallA = 0;
int bmw_HallC_pause = 0;  // to run SL20 without HallC pause enabled, HallC down during PVDIS, 13Nov09, rupesh
...
int bmw_steps_per_qcycle =    3; /* Number of steps per 1/4 cycle, 3*/ 
int bmw_steps_per_pause  = 1440; /* Number of steps to rest after last object, 1440*/
int bmw_ticks_per_step   =   24; /* Clock ticks per step, 24 = 1/3 sec*/ 
...
int bmw_FFBpause_wait    =    9; /* number of steps before/after cycle for FFB pause*/

int bmw_FFBresume_wait    =  9; /* number of steps before/after cycle for FFB resume*/
...
STATUS bmwClient_script ()
{
  ...
  while (!bmw_die_die_die)  {
	...
	if (bmw_RFlock_in_HallC==1) {
	  ...
	  //
	  // blank this out below for PVDIS, Hall C down, 13Nov09, rupesh		
	  if(bmw_HallC_pause){
	...
	if ( server >= 0 ) {
	  ...
	  if (bmw_RFlock_in_HallC==1) {
	    ...
	    //
     	    // disable HallC pause for PVDIS, Hall C down, 13Nov09, rupesh
	    if(bmw_HallC_pause){
  ...
  if (bmw_RFlock_in_HallC==1 && bmw_ending_object>6) {
...
STATUS setupRequests ()
{
  ...
  for ( i = 0; i < MAX_OBJS; i++ )
    strcpy ( bmwObjlist[i], "" );
  strcpy ( bmwObjlist[0], "MHF1C01H" );
  strcpy ( bmwObjlist[1], "MHF1C02H" );
  strcpy ( bmwObjlist[2], "MHF1C03V" );
  strcpy ( bmwObjlist[3], "MHF1C08H" );
  strcpy ( bmwObjlist[4], "MHF1C08V" );
  strcpy ( bmwObjlist[5], "MHF1C10H" );
  strcpy ( bmwObjlist[6], "MHF1C10V" );
  strcpy ( bmwObjlist[7], "SL ZONE 20" ); 
