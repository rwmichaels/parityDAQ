...
FOREVER {
   ...
   if (DEBUG) {
     logMsg("\n scaloop: Chk scalers. coda_run_flag = %d \n",coda_run_flag,0,0,0,0,0);
   }

   if ( coda_run_flag == 0 ) {  /* CODA not running */
   ...
   } else {     /* coda_run_flag==1 --> CODA is running */
